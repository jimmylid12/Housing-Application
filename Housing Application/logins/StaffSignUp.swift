...
//page which allows staff to signup- once done they are logged in and taken to homepage

import SwiftUI
import Firebase

struct StaffSignUp: View {
...
struct StaffSignUp_Previews: PreviewProvider {

...
struct PropertyDetailsStaff: View {
...
struct PropertyDetailsStaff_Previews: PreviewProvider
...

{
    ...
    {
        PropertyDetailsStaff(showHeadFoot: true, post: post)
    }
}
